  ...
  <div class="reg_frm_wrap right" style="margin-top:40px;margin-right:20px;margin-bottom:15px;">
    <div style="background-color:#834DAB;padding-top:2px;">
     <ul class="nav inline-nav" style="padding-bottom:0px;text-align:left;">
      <li><a href="javascript:void(0);" onclick="document.getElementById('Profile').style.display = 'block';document.getElementById('Accolades').style.display = 'none';document.getElementById('Team').style.display = 'none';" class="panel-active-tab" >Sparshh Profile</a></li>
      <li><a href="javascript:void(0);" class="panel-inactive-tab" onclick="document.getElementById('Profile').style.display = 'none';document.getElementById('Accolades').style.display = 'block';document.getElementById('Team').style.display = 'none';">Sparshh Accolades</a></li>
      <li><a href="javascript:void(0);" class="panel-inactive-tab" onclick="document.getElementById('Profile').style.display = 'none';document.getElementById('Accolades').style.display = 'none';document.getElementById('Team').style.display = 'block';">Sparshh Team</a></li>  
     </ul>
   ...
   <div id="Accolades" style="display:none;">
        <p style="padding:10px;color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">&nbsp;&nbsp;“sparshh.com” has grown with high pace in matchmaking arena. Our journey is crowned with many social accolades like –</p>
        <div class="frm-divider"></div>
        <p style="padding:10px;color:#555555;font-family: Georgia,serif;text-align: left;font-weight:bold;">&nbsp;&nbsp;a.The only matrimony which is dispensing superior lucrative services with comparable and affordable prices to serve all the socio-economic class of people.</p>
        <div class="frm-divider"></div>
        <p style="padding:10px;color:#555555;font-family: Georgia,serif;text-align: left;font-weight:bold;">&nbsp;&nbsp;b.Have been successful in establishing accomplished unions all over India and world since inception.</p>
        <div class="frm-divider"></div>
        <p style="padding:10px;color:#555555;font-family: Georgia,serif;text-align: left;font-weight:bold;" >&nbsp;&nbsp;c.First matrimony in India to introduce one time registration charge valid till marriage.</p>
        <div class="frm-divider"></div>
        <p style="padding:10px;color:#555555;font-family: Georgia,serif;text-align: left;font-weight:bold;" >&nbsp;&nbsp;d.	First matrimony to Endeavour Post Wedding Celebration in members.</p>
   </div>
