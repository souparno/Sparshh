...
public partial class Users_Profile : System.Web.UI.Page
{
    ...
    {
        string usr_id = Convert.ToString(Session["UserId"]);
    ...
    protected void UpdateAboutMe_Click(object sender, EventArgs e)
    {
        string AboutMe = Request.Form["txt_about_me"];
        string usr_id = Convert.ToString(Session["UserId"]);

        SqlConnection con = new SqlConnection(_connection);
        string sql = "update usr_details set usr_about='" + AboutMe + "'  where usr_id='" + usr_id + "';";
    ...
    private void fill_basic_info()
    {
        ...
        var query = from t7 in
                    ...
                    select new
                    {
                        ProfilePostedBy_Key = t7.ProfilePostedBy_Key,
    ...
    {
        string profileposted_by = Request.Form["ddl_profileposted_by_edit"];
        string name = Request.Form["txt_name_edit"];
        string gender = Request.Form["gender"];
        string dob_day = Request.Form["ddl_dob_day"];
        string dob_month = Request.Form["ddl_dob_month"];
        string dob_year = Request.Form["ddl_dob_year"];
        string marital_status = Request.Form["ddl_marital_status_edit"];
        string no_of_children = Request.Form["ddl_no_of_Children"];
        string childrenLivinWith = Request.Form["ddl_children_living_with"];
        string usr_id = Convert.ToString(Session["UserId"]);

        SqlConnection con = new SqlConnection(_connection);
        string sql = "update usr_details set usr_profile_posted_by='" + profileposted_by + "',usr_name='" + name + "',usr_gender='" + gender + "',usr_dob_day='" + dob_day + "',usr_dob_month='" + dob_month + "',usr_dob_year='" + dob_year + "',usr_marital_status='" + marital_status + "',usr_no_of_children='"+no_of_children+"',usr_children_living_with='"+childrenLivinWith+"'  where usr_id='" + usr_id + "';";
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void UpdateEducationOccupation_Click(object sender,EventArgs e)
    {
        string Occupation = Request.Form["ddl_occupation_edit"];
        string HighestEducation = Request.Form["ddl_highest_education_edit"];
        string Income = Request.Form["ddl_income_edit"];
        string education_details = Request.Form["txt_education_detail"];
        string occupation_details = Request.Form["Occupation_details"];
        string UserId = Convert.ToString(Session["UserId"]);
        

        SqlConnection con = new SqlConnection(_connection);
        string sql = "update usr_details set usr_occupation='" + Occupation + "',usr_highest_education='"+HighestEducation+"',usr_income='"+Income+"',usr_occupation_details='"+occupation_details+"',usr_education_details='"+education_details+"'  where usr_id='" + UserId + "';";
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void Update_ReligiousArrribute_Click(object sender,EventArgs e)
    {

        string religion = Request.Form["ddl_religion_edit"];
        string caste = Request.Form["ddl_Caste_edit"];
        string mother_tongue = Request.Form["ddl_mother_tongue_edit"];
        string mangalik = Request.Form["ddl_mangalik_edit"];
        string Nakshatra = Request.Form["ddl_nakshatra_edit"];
        string Sunsign = Request.Form["sunsign_edit"];
        string Gotra = Request.Form["txt_gotra_edit"];
        string SubCaste = Request.Form["txt_subcaste_edit"];
        string BirthPlace = Request.Form["txt_birth_place_edit"];
        string UserId = Convert.ToString(Session["UserId"]);
        
        SqlConnection con = new SqlConnection(_connection);
        string sql = "update usr_details set usr_religion='" + religion + "',usr_caste='" + caste + "',usr_mother_tongue='"+mother_tongue+"',usr_mangalik='"+mangalik+"',usr_nakshatra='"+Nakshatra+"',usr_sunsign='"+Sunsign+"',usr_subcaste='"+SubCaste+"',usr_gotra='"+Gotra+"',usr_birth_place='"+BirthPlace+"'  where usr_id='" + UserId + "';";
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void Update_PhysicalArrribute_Click(object sender, EventArgs e)
    {

        string Height = Request.Form["ddl_height_edit"];
        string Weight = Request.Form["txt_weight_edit"];
        string Challanged = Request.Form["ddl_challanged_edit"];
        string Diet = Request.Form["ddl_diet_edit"];
        string BloodGroup = Request.Form["ddl_blood_group_edit"];

        
        string usr_id = Convert.ToString(Session["UserId"]);

        string sql = "update usr_details set usr_height='"+Height+"',usr_weight='"+Weight+"',usr_challanged='"+Challanged+"',usr_diet='"+Diet+"',usr_blood_group='"+BloodGroup+"' where usr_id='"+usr_id+"'";
        SqlConnection con = new SqlConnection(_connection);
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
    ...
    public void UpdateContactInformation_Click(object sender,EventArgs e)
    {
        string Email = Request.Form["txt_email_edit"];
        string MobileNo = Request.Form["txt_mob_no_edit"];
        string LandNo = Request.Form["txt_land_no_edit"];
        string Address=Request.Form["txt_address_edit"];
        string city = Request.Form["txt_city_edit"];
        string state = Request.Form["txt_state_edit"];
        string Country = Request.Form["ddl_country"];
        string usr_id = Convert.ToString(Session["UserId"]);

        string sql = "update usr_details set usr_email='"+Email+"',usr_mobile='"+MobileNo+"',usr_land_no='"+LandNo+"',usr_address='"+Address+"',usr_state='"+state+"',usr_city='"+city+"',usr_country='"+Country+"' where usr_id='"+usr_id+"';";
        SqlConnection con = new SqlConnection(_connection);
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
    ...
    public void UpdateFamilyDetails_Click(object sender, EventArgs e)
    {
        string FamilyValue = Request.Form["ddl_family_value"];
        string FamilyType = Request.Form["ddl_family_type"];
        string AncestralOrigin = Request.Form["txt_ancestral_origin"];
        string FathersOccupation = Request.Form["txt_fathers_occupation"];
        string MothersOccupation = Request.Form["txt_mothers_occupation"];
        string brothers = Request.Form["txt_brothers"];
        string sisters = Request.Form["txt_sisters"];
        string brothers_married = Request.Form["txt_brothers_married"];
        string sisters_married = Request.Form["txt_sisters_married"];
        string usr_id = Convert.ToString(Session["UserId"]);

        string sql = "update usr_details set usr_family_value='" + FamilyValue + "',usr_family_type='" + FamilyType + "',usr_ancestral_origin='" + AncestralOrigin + "',usr_fathers_occupation='" + FathersOccupation + "',usr_mothers_occupation='" + MothersOccupation + "',usr_brothers='" + brothers + "',usr_sisters='"+sisters+"',usr_brothers_married='"+brothers_married+"',usr_sister_married='"+sisters_married+"' where usr_id='" + usr_id + "';";
        SqlConnection con = new SqlConnection(_connection);
        SqlCommand cmd = new SqlCommand(sql, con);
        con.Open();
        cmd.ExecuteNonQuery();
    ...
    public static string get_caste(string religion_key)
    {
        ...
        string inner_html = "<option value='0'>--Select Caste</option>";
        foreach (var row in query)
        {
            inner_html = inner_html + "<option value='" + row.Key + "'>" + row.Value + "</option>";
