  ...
  <div class="reg_frm_wrap right" style="margin-top:40px;margin-right:20px;margin-bottom:15px;">
    <div style="background-color:#834DAB;padding-top:2px;">
     <ul class="nav inline-nav" style="padding-bottom:0px;">
      <li><a href="javascript:void(0);" class="panel-active-tab"   id="package_tab"   onclick="document.getElementById('packages').style.display = 'block';document.getElementById('privilage').style.display = 'none';document.getElementById('elite').style.display = 'none';document.getElementById('club').style.display = 'none';document.getElementById('package_tab').className='panel-active-tab';document.getElementById('privilage_tab').className='panel-inactive-tab';document.getElementById('elite_tab').className='panel-inactive-tab';document.getElementById('club_tab').className='panel-inactive-tab';">Sparshh Packages</a></li>
      <li><a href="javascript:void(0);" class="panel-inactive-tab" id="privilage_tab" onclick="document.getElementById('packages').style.display = 'none';document.getElementById('privilage').style.display = 'block';document.getElementById('elite').style.display = 'none';document.getElementById('club').style.display = 'none';document.getElementById('package_tab').className='panel-inactive-tab';document.getElementById('privilage_tab').className='panel-active-tab';document.getElementById('elite_tab').className='panel-inactive-tab';document.getElementById('club_tab').className='panel-inactive-tab';">Sparshh Privilage</a></li>
      <li><a href="javascript:void(0);" class="panel-inactive-tab" id="elite_tab"     onclick="document.getElementById('packages').style.display = 'none';document.getElementById('privilage').style.display = 'none';document.getElementById('elite').style.display = 'block';document.getElementById('club').style.display = 'none';document.getElementById('package_tab').className='panel-inactive-tab';document.getElementById('privilage_tab').className='panel-inactive-tab';document.getElementById('elite_tab').className='panel-active-tab';document.getElementById('club_tab').className='panel-inactive-tab';">Sparshh Elite</a></li>
      <li><a href="javascript:void(0);" class="panel-inactive-tab" id="club_tab"      onclick="document.getElementById('packages').style.display = 'none';document.getElementById('privilage').style.display = 'none';document.getElementById('elite').style.display = 'none';document.getElementById('club').style.display = 'block';document.getElementById('package_tab').className='panel-inactive-tab';document.getElementById('privilage_tab').className='panel-inactive-tab';document.getElementById('elite_tab').className='panel-inactive-tab';document.getElementById('club_tab').className='panel-active-tab';">Sparshh Club</a></li>  
     </ul>
   ...
   <div class="form_inner_wrap" style="width:598px;">
        ...
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">1. Access to verified closest matches for 3 months, 6 months and 9 months respectively.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">2. Basic verification of profile’s background, qualification, Profession, Family etc by Sparshh.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">3. Filling formats, collecting documents, photographs from member.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">4. Matchmaking service through Customer Service Officer for 12 months.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">5. Help in searching and short listing profiles based on the criterion laid down by both the sides.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">6. Establishing communication with closest match after your selection and approval of the same.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">7. Personalized e-mail to all matching profiles.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">8. Basic verification of the profiles like Life style analysis, life history, family details, property details, qualification, profession, remuneration through Sparshh (THIS FACILITY WILL BE AVAILABLE FOR ALL INDIA).</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">9. Arrangement of meeting between both the families in a convenient place chosen by them.</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">10. You will be allotted one day in a week for searching, short-listing, sending the profiles to the verified closest matches and also One day for taking the feedback from them and also for sharing the same to you.(Days & Time will be intimated to you before preceding your services)</p>
        <p style="color:#555555;font-family: Georgia,serif;text-align:left;font-weight:bold;">11. Computerized Compatibility match will be pursued with final match to finalize the negotiation.</p>
        </div>
