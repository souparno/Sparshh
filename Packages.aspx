...
<div class="row size-12" style="background-image:url(Assets/images/backgroung-image.jpg);background-position:0px 0px;background-size:100% auto;background-repeat:repeat-x;margin-bottom:0px;min-height: 780px;">
  ...
  <div class="reg_frm_wrap right" style="margin-top:40px;margin-right:20px;margin-bottom:15px;">
   ...
   <div class="form_inner_wrap" style="width:598px;">
        ...
        <p>10. You will be allotted one day in a week for searching, short-listing, sending the profiles to the verified closest matches and also One day for taking the feedback from them and also for sharing the same to you.(Days & Time will be intimated to you before preceding your services)</p>
...
<p >9.	International data verification also can be arranged on demand with own cost payable to the agency directly. </p>
<p >10.	You are entitled to receive choices for Professional Detective Agency verification as per the necessity. (1. One pan India verification with Two local verification Or, 2. Three local verifications.)</p>
<center><button type="button" class="purple" onclick="document.getElementById('background-overlay').style.display='block';document.getElementById('popup_spartshhclub').style.display='block';">Read More</button></center>
